...
// import UserAppointments from "../components/UserAppointments"; // TODO: Create this component
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div>
            ...
            <>
              ...
              <div className="grid md:grid-cols-3 gap-4 md:col-span-2">
                ...
                <div className="md:col-span-2 flex items-center gap-3 mt-2">
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} type="submit" disabled={saving} className="bg-yellow-500 text-white px-6 py-3 rounded-xl shadow disabled:opacity-50">
          ...
          {activeTab === "appointments" && isPetOwner && (
            <div className="bg-white rounded-2xl shadow-xl p-6">
              <h2 className="text-xl font-bold text-yellow-700 mb-4">My Appointments</h2>
              <p className="text-gray-600">Your appointments will appear here.</p>
              {/* TODO: Replace with <UserAppointments userId={user?._id || user?.id} /> when component is created */}
            </div>
          )}
        </div>
      </div>
